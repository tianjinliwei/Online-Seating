 ...
 */
console.log("\u767e\u5ea6\u641c\u7d22\u3010\u7d20\u6750\u5bb6\u56ed\u3011\u4e0b\u8f7d\u66f4\u591aJS\u7279\u6548\u4ee3\u7801"); (function(e) {
            ...
            u = function(t, n) {
                return function(i) {
                    ...
                    s.settings.$node.attr({
                        ...
                        focusable: true,
                        tabIndex: -1
                    }).text(' ').addClass(["seatCharts-seat", "seatCharts-cell", "available"].concat(s.settings.classes, typeof n.seats[s.settings.character] == "undefined" ? [] : n.seats[s.settings.character].classes).join(" "));
